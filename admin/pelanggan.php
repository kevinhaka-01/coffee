        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name">COFFIE SHOP</span>
            </a>
            ...
            <div class="col-xl-12 grid-margin stretch-card flex-column">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="tabel/pelanggan/tambah.php">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="tabel/pelanggan/update.php?id=<?= $d['PelangganID'] ?> ">

                                <label class="badge badge-warning">Update</label>
                            </a>
                            <a href="tabel/pelanggan/hapus.php?id=<?= $d['PelangganID'] ?> ">
