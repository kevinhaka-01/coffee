            ...
            <div class="col-xl-12 grid-margin stretch-card flex-column">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="tabel/rincianpesanan/tambah.php">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                        require 'koneksi.php';
                        $sql = mysqli_query($koneksi , "SELECT * FROM rincianpesanan");
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="tabel/rincianpesanan/update.php?id=<?= $d['RincianPesananID'] ?> ">

                               
                            </a>
                            <a href="tabel/rincianpesanan/hapus.php?id=<?= $d['RincianPesananID'] ?> ">
