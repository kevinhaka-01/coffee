                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <thead>
                        <tr>
                          <th>KodePromo </th>
                          <th>DeskripsiPromo</th>
                          <th>Diskon</th>
                          <th>TanggalMulai</th>
                          <th>TanggalBerakhir</th>
                          <th>Status</th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        <tr>
                          <td><?= $d['KodePromo'] ?></td>
                          <td><?= $d['DeskripsiPromo'] ?></td>
                          <td><?= $d['Diskon'] ?></td>
                          <td><?= $d['TanggalMulai'] ?></td>
                          <td><?= $d['TanggalBerakhir'] ?></td>
                
                          <td>
                            <a href="tabel/promo/update.php?id=<?= $d['PromoID'] ?> ">

                                <label class="badge badge-warning">Update</label>
                            </a>
                            <a href="tabel/promo/hapus.php?id=<?= $d['PromoID'] ?> ">
