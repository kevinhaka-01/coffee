...
<body>
            ...
            <div class="col-xl-12 grid-margin stretch-card flex-column">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="tabel/kategoriproduk/tambah.php">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                        require 'koneksi.php';
                        $sql = mysqli_query($koneksi , "SELECT * FROM kategoriproduk");
                        while($d = mysqli_fetch_array($sql)){
                        ?>
                        <tr>
                          <td><?= $d['NamaKategori'] ?></td>
                          <td><?= $d['DeskripsiKategori'] ?></td>
                
                          <td>
                            <a href="tabel/kategoriproduk/update.php?id=<?= $d['KategoriProdukID'] ?> ">

                                <label class="badge badge-warning">Update</label>
                            </a>
                            <a href="tabel/kategoriproduk/hapus.php?id=<?= $d['KategoriProdukID'] ?> ">
  ...
  <script src="assets/vendors/js/settings.js"></script>
  <script src="assets/vendors/js/todolist.js"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="assets/vendors/js/dashboard.js"></script>
